...
{/* <h2 class="distanciavalor"></h2>
<input type='range' class='inputdistancia' name='dist' min='0' max='4' value='0' step='0.1'></input> */}
let rangedistancia = document.querySelector('.inputdistancia');
let distanciavalor = document.querySelector('.distanciavalor');
distanciavalor.innerHTML = `<h2 id="distanciavalor"> ${rangedistancia.value}m</h2>`;
rangedistancia.addEventListener('input', function () {
  distanciavalor.innerHTML = `<h2 id="distanciavalor"> ${rangedistancia.value}m</h2>`;
});
...
setInterval(function() {
  ...
  document.getElementById("hora-atual").innerHTML = `Hora digital ${hora}:${minutos}:${segundos}`;
